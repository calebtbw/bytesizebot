...
class SettingsPage(QtWidgets.QWidget):
    ...
    def save_settings(self):
        ...
        self.update_settings(settings)
        QtWidgets.QMessageBox.information(self, "Bytesize Bot", "Saved Settings")

    def update_settings(self, settings_data):
        global webhook, webhook_on_browser, webhook_on_order, webhook_on_failed, browser_on_failed, bb_ac_beta, dont_buy, random_delay_start, random_delay_stop
